...
static const CGFloat ULCToastOpacity            = 0.5;
...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:ULCToastOpacity];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:ULCToastOpacity];
